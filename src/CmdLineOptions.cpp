...
namespace xmreg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "evoxblocks, Onion Babycoin Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Babycoin total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.babycoin/lmdb")
                ...
                ("deamon-url,d", value<string>()->default_value("http://127.0.0.1:51022"),
                 "Babycoin deamon url");
