...
main(int ac, const char* av[])
{
    ...
    if (testnet && deamon_url == "http://127.0.0.1:51022")
        deamon_url = "http://127.0.0.1:53922";
    if (stagenet && deamon_url == "http://127.0.0.1:51902")
